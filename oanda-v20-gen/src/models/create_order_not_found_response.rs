...
pub struct CreateOrderNotFoundResponse {
    ...
    pub order_reject_transaction: Option<Box<models::Transaction>>,
}

impl CreateOrderNotFoundResponse {
    pub fn new() -> CreateOrderNotFoundResponse {
