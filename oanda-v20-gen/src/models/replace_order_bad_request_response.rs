...
pub struct ReplaceOrderBadRequestResponse {
    ...
    pub order_client_extensions_modify_reject_transaction: Option<Box<models::Transaction>>,
}

impl ReplaceOrderBadRequestResponse {
    pub fn new() -> ReplaceOrderBadRequestResponse {
